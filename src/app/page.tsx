...
/* ═══════════════════════════════════════════════════════════════
   Homepage — Clean reset.

   The procedural FuzzyWorld / CyberForest / GLB stack has been
   replaced with a static-image hero + the existing below-fold
   marketing sections (GamesShowcase, PrizeTiers, etc.). The 3D
   files remain in the repo under src/components/world/* and
   src/components/hero/scene/* so a future revert is one import
   change away.

   SITE_LOCKDOWN_PASSWORD middleware (or what's left of it) is
   unaffected.
   ═══════════════════════════════════════════════════════════════ */
