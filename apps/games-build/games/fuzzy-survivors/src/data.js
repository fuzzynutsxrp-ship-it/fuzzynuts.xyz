...
export const WEAPONS = {
    WHIP: {
        ...
        name: 'Tail Swipe',
        icon: '🐿️',
        description: 'Lashes to both sides. Evolves: full circle sweep.',
        baseDamage: 20,
        baseCooldown: 1.5,
        baseRange: 90,
        projectileCount: 1,
    ...
    MAGIC_WAND: {
        ...
        name: 'Acorn Shot',
        icon: '🌰',
        description: 'Homing acorn seeks the closest foe. Evolves: triple volley.',
        baseDamage: 15,
        baseCooldown: 1.2,
        baseRange: 320,
        projectileCount: 1,
    ...
    KNIFE: {
        ...
        name: 'Thorn',
        icon: '🌿',
        description: 'Piercing thorn thrown forward. Evolves: wide 5-thorn fan.',
        baseDamage: 12,
        baseCooldown: 0.4,
        baseRange: 420,
        projectileCount: 1,
    ...
    ORBIT: {
        ...
        name: 'Nut Shield',
        icon: '🥜',
        description: 'Spinning nuts circle the squirrel. Evolves: two rings.',
        baseDamage: 16,
    ...
    MINE: {
        ...
        name: 'Pinecone Bomb',
        icon: '🌲',
        description: 'Drops a pinecone that arms and detonates. Evolves: cluster.',
        baseDamage: 45,
        baseCooldown: 2.2,
    ...
    GARLIC: {
        ...
        name: 'Stink Cloud',
        icon: '💨',
        description: 'Damaging aura around the squirrel.',
        baseDamage: 5,
        baseCooldown: 0.2,
        baseRange: 110,
        piercing: true,
...
// ---------------------------------------------------------------------------
export const WAVES = [
    { from: 0, to: 30, pool: ['bat', 'zombie'], spawnMult: 1.0, label: 'Rustling' },
    { from: 30, to: 60, pool: ['bat', 'zombie', 'skeleton'], spawnMult: 1.1, label: 'Foragers' },
    {
        from: 60,
        to: 90,
...
export const ACHIEVEMENTS = [
    ...
    // --- v2.4 additions ---------------------------------------------------
    {
        ...
        name: 'Speed Demon',
        icon: '💨',
        description: 'Defeat the Ancient Treant in under 5 minutes of real time.',
        check: (c) =>
