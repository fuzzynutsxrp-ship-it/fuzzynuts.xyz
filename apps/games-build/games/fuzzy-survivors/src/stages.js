...
export const STAGES = Object.freeze({
    FOREST: Object.freeze({
        ...
        name: 'Acorn Hollow',
        icon: '🍂',
        description: 'Autumn woodland. Balanced enemy mix, bosses on schedule.',
        background: { fill: '#1a1a0e', gridAlpha: 0.04 },
        musicStyle: 'forest',
        poolOverrides: {},
        extraEnemies: [],
        bossOffsets: {}
    ...
    CRYPT: Object.freeze({
        ...
        name: 'Foxden Burrow',
        icon: '🪹',
        description: 'Underground tunnels. More ranged hunters. Alpha Wolf at 4:00.',
    ...
    TUNDRA: Object.freeze({
        ...
        background: { fill: '#1a2a3f', gridAlpha: 0.05 },
        musicStyle: 'forest',
        poolOverrides: {
