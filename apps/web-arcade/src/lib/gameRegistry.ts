...
export const GAME_LIST: GameMetadata[] = [
  ...
  },
  {
    ...
    color: "#10b981",
    description:
      "Classic snake game with power-ups. Grow your snake by eating food, avoid walls and yourself!",
    scoreCap: 50000,
    minPlayTime: 15,
  ...
  },
  {
    ...
    color: "#f59e0b",
    description:
      "Smash through bricks with bouncing balls! Classic breakout action with power-ups and increasing difficulty.",
    scoreCap: 100000,
    minPlayTime: 15,
  ...
  },
  {
    ...
    loadingTips: [
      ...
      "Angle returns with paddle edge",
      "AI adapts — switch strategies!",
    ],
  ...
  },
  {
    ...
    color: "#7c3aed",
    description:
      "Stack falling blocks and clear lines! The timeless puzzle game with increasing speed.",
    scoreCap: 999999,
    minPlayTime: 15,
    controls: [
    ...
    scoreType: "high-score",
    loadingTips: [
      "Clear lines by filling complete rows",
      "Tetrises (4 lines) earn bonus points",
      "Speed increases every 10 lines",
      "Use hard drop for instant placement",
    ],
  ...
  },
  {
    ...
    color: "#ef4444",
    description:
      "Navigate through an asteroid field! Shoot rocks, dodge debris, and survive waves of increasing danger.",
    scoreCap: 500000,
    minPlayTime: 15,
    ...
    scoreType: "high-score",
    loadingTips: [
      "Thrust with Up, rotate with Left/Right",
      "Large asteroids split into smaller ones",
      "Small asteroids = more points",
      "Hyperspace jump with Shift — risky!",
    ],
  ...
  },
  {
    ...
    scoreType: "high-score",
    loadingTips: [
      "Flap through pipes and see how far you can go! Tap to flap, dodge the obstacles.",
    ],
  ...
  },
  {
    ...
    color: "#22c55e",
    description:
      "Command your tank in fast-paced top-down combat across destructible arenas. Outmaneuver enemy tanks, collect power-ups, and blast through walls to gain the tactical advantage. Each wave brings smarter foes and tighter maps.",
    scoreCap: 500000,
    minPlayTime: 15,
    controls: ["WASD to move", "Space to shoot"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/tank-battle/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Command your tank in top-down combat!"],
  ...
  },
  {
    ...
    color: "#f97316",
    description:
      "Pilot a helicopter through a never-ending cave system filled with stalactites, moving pillars, and narrow squeezes. Tap to gain altitude, release to descend, and thread the needle through increasingly tight gaps. How far can you fly before the cave wins?",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Space/click to fly", "Release to fall"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/helicopter/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Fly through a side-scrolling cave!"],
    touchHint: "Hold to fly, release to fall",
  },
  {
    slug: "fruit-ninja",
    title: "Fruit Ninja",
    ...
    color: "#ef4444",
    description:
      "Slice through waves of flying fruit with precision swipes but watch out for bombs that end your run! Chain combos by slicing multiple fruit in a single swipe for massive bonus points. Rack up the highest score before your three strikes are up.",
    scoreCap: 999999,
    minPlayTime: 15,
    controls: ["Mouse/touch to slice"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/fruit-ninja/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Slice flying fruit with your blade!"],
    touchHint: "Swipe to slice fruit",
  },
  {
    slug: "tower-defense",
    title: "Tower Defense",
    ...
    color: "#7c3aed",
    description:
      "Strategically place and upgrade towers to defend your base against waves of enemies. Mix and match tower types to find the perfect defense combo. Plan your layout wisely; each wave gets tougher.",
    scoreCap: 999999,
    minPlayTime: 15,
    controls: ["Click to place towers"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/tower-defense/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Build towers to defend your base!"],
    touchHint: "Tap to place and upgrade towers",
  },
  {
    slug: "space-invaders",
    ...
    color: "#06b6d4",
    description:
      "Defend Earth from descending waves of alien invaders in this arcade classic. Move your ship left and right, blast the aliens before they reach the ground, and take cover behind destructible shields. The aliens speed up as their numbers thin.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Arrow keys to move", "Space to shoot"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/space-invaders/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Defend Earth from alien invaders!"],
    touchHint: "Drag to move, auto-fire",
  },
  {
    slug: "boxing",
    title: "Boxing",
    ...
    color: "#ef4444",
    description:
      "Step into the ring and duke it out in a fast-paced boxing match. Throw jabs, hooks, and uppercuts while dodging and weaving to avoid your opponents counter-attacks. Timing is everything; land combos to daze your rival and go for the knockout.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["J/K/L for punches", "Arrow keys to dodge"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/boxing/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Step into the ring!"],
    touchHint: "Tap punch buttons, swipe to dodge",
  },
  {
    slug: "bowling",
    title: "Bowling",
    ...
    color: "#f97316",
    description:
      "Aim, set your power, and add spin to roll the perfect frame in this 10-pin bowling game. Adjust your approach angle and release timing to pick up tricky spares and nail those satisfying strikes. Can you bowl a perfect 300?",
    scoreCap: 300,
    minPlayTime: 15,
    controls: ["Mouse/touch to aim and throw"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/bowling/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Roll strikes in 10-pin bowling!"],
    touchHint: "Drag to aim, release to throw",
  },
  {
    slug: "archery",
    title: "Archery",
    ...
    color: "#10b981",
    description:
      "Take aim at distant targets and test your precision in this archery challenge. Factor in wind direction and distance as you pull back and release for bullseye shots. Climb the scoring ladder by hitting closer to center with every round.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Mouse/touch to aim and shoot"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/archery/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Hit the bullseye!"],
    touchHint: "Drag to aim, release to shoot",
  },
  {
    slug: "surf-up",
    title: "Surf Up",
    ...
    color: "#06b6d4",
    description:
      "Carve through ocean waves and pull off tricks for bonus points in this surfing game. Balance your rider on the face of the wave, launch off the lip for aerials, and chain tricks for massive multipliers. Ride as far as you can without wiping out.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Arrow keys to balance", "Space for tricks"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/surf-up/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Ride the waves!"],
    touchHint: "Tilt to balance, tap for tricks",
  },
  {
    slug: "rally",
    title: "Rally",
    ...
    color: "#fbbf24",
    description:
      "Race through procedurally generated tracks in a top-down rally racer. Drift around corners, dodge obstacles, and use nitro boosts to shave seconds off your lap time. Each track gets more technical; master the handbrake to stay on the road.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Arrow keys to steer/accelerate", "Space for handbrake"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/rally/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Top-down rally racing!"],
    touchHint: "Buttons to steer and accelerate",
  },
  {
    slug: "maze-escape",
    title: "Maze Escape",
    ...
    color: "#a855f7",
    description:
      "Navigate procedurally generated mazes that grow larger and more complex with each level. Find the exit before the timer runs out while collecting bonus items scattered throughout the maze. Race against the clock; can you escape every maze thrown at you?",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Arrow keys to move"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/maze-escape/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Navigate procedural mazes!"],
  ...
  },
  {
    ...
    color: "#10b981",
    description:
      "Guide your frog across busy highways and treacherous rivers to reach the safe lily pads on the other side. Time your crossings between speeding cars, then hop across logs and turtles floating down the river. One wrong move and its game over.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Arrow keys to move"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/frogger/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Cross the road and river!"],
    touchHint: "Swipe to move",
  },
  {
    slug: "bomberman",
    title: "Bomberman",
    ...
    color: "#f97316",
    description:
      "Place strategic bombs to blast through walls and trap enemies in this classic arena game. Collect power-ups to increase your blast range, add more bombs, and gain speed as you clear the map. Outlast every enemy to advance to the next stage.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Arrow keys to move", "Space to place bomb"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/bomberman/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Place bombs, break walls, defeat enemies!"],
    touchHint: "Swipe to move, tap to bomb",
  },
  {
    slug: "capture-flag",
    ...
    color: "#ef4444",
    description:
      "Challenge a friend to local 2-player capture the flag in split-screen mode. Sneak into the opponents half, grab their flag, and race it back to your base while defending your own. Fast reflexes and smart positioning decide who takes the win.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["P1: WASD + Space", "P2: Arrows + Enter"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/capture-flag/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["2-player local capture the flag!"],
    touchHint: "Split screen — each half for one player",
  },
  {
    slug: "tower-stack",
    title: "Tower Stack",
    ...
    color: "#fbbf24",
    description:
      "Drop blocks with precision timing to build the tallest tower you can. Each block swings back and forth; tap to drop it, but any misalignment trims the platform smaller. The tighter your timing, the wider your tower stays as it climbs higher.",
    scoreCap: 99999,
    minPlayTime: 15,
    controls: ["Space/click to drop block"],
    iconPath: "/icons/icon-world-pop.webp",
    iframePath: "/games/tower-stack/",
    sandbox: DEFAULT_SANDBOX,
    leaderboardEnabled: true,
    achievementsEnabled: false,
    status: "live",
    scoreType: "high-score",
    loadingTips: ["Stack blocks precisely!"],
    touchHint: "Tap to drop the block",
  },
];
