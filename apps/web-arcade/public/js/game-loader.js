...
(() => {
  ...
  const GAME_CONFIG = {
    ...
    'flappy': { engine: 'inline', path: '/games/flappy/' },
    'subway-runner': { engine: 'inline', path: '/games/subway-runner/' },
    'jetpack': { engine: 'inline', path: '/games/jetpack/' },
    'ski-free': { engine: 'inline', path: '/games/ski-free/' },
    'doodle-jump': { engine: 'inline', path: '/games/doodle-jump/' },
    '2048': { engine: 'inline', path: '/games/2048/' },
    'memory': { engine: 'inline', path: '/games/memory/' },
    'minesweeper': { engine: 'inline', path: '/games/minesweeper/' },
    'sudoku': { engine: 'inline', path: '/games/sudoku/' },
    'wordle': { engine: 'inline', path: '/games/wordle/' },
    'tank-battle': { engine: 'inline', path: '/games/tank-battle/' },
    'helicopter': { engine: 'inline', path: '/games/helicopter/' },
    'fruit-ninja': { engine: 'inline', path: '/games/fruit-ninja/' },
    'tower-defense': { engine: 'inline', path: '/games/tower-defense/' },
    'space-invaders': { engine: 'inline', path: '/games/space-invaders/' },
    'boxing': { engine: 'inline', path: '/games/boxing/' },
    'bowling': { engine: 'inline', path: '/games/bowling/' },
    'archery': { engine: 'inline', path: '/games/archery/' },
    'surf-up': { engine: 'inline', path: '/games/surf-up/' },
    'rally': { engine: 'inline', path: '/games/rally/' },
    'maze-escape': { engine: 'inline', path: '/games/maze-escape/' },
    'frogger': { engine: 'inline', path: '/games/frogger/' },
    'bomberman': { engine: 'inline', path: '/games/bomberman/' },
    'capture-flag': { engine: 'inline', path: '/games/capture-flag/' },
    'tower-stack': { engine: 'inline', path: '/games/tower-stack/' },
