...
export class UI {
    ...
    showGameOver(game) {
        ...
        // Populate Fuzzynuts Arcade composite score display
        const arcadeScoreEl = document.getElementById('arcadeScoreVal');
        if (arcadeScoreEl && typeof game.arcadeScore === 'number') {
            arcadeScoreEl.textContent = game.arcadeScore.toLocaleString();
        }
