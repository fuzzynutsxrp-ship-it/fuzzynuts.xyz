...
const STRINGS = {
    en: {
        ...
        subtitle: 'A Fuzzynuts Arcade roguelite',
        start: 'Start Run',
        continue: 'Continue',
        settings: 'Settings',
        ...
        howToBody2: 'Pick up golden acorns to gain XP. Each level lets you choose one upgrade.',
    ...
    zh: {
        title: '毛绒生存者',
        subtitle: 'Fuzzynuts 风格 Roguelite',
        start: '开始游戏',
        continue: '继续',
        settings: '设置',
        howToPlay: '玩法',
